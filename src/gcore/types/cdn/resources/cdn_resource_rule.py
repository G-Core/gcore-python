...
class CdnResourceRule(BaseModel):
    ...
    origin_protocol: Optional[Literal["HTTPS", "HTTP", "MATCH"]] = FieldInfo(alias="originProtocol", default=None)
    ...
    primary_rule: Optional[int] = None
    """
