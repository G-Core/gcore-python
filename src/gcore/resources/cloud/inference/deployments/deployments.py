...
from .deployments_custom import DeploymentsResourceCustomMixin, AsyncDeploymentsResourceCustomMixin
...
class DeploymentsResource(DeploymentsResourceCustomMixin, SyncAPIResource):
    """
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            path_template("/cloud/v3/inference/{project_id}/deployments", project_id=project_id),
...
class AsyncDeploymentsResource(AsyncDeploymentsResourceCustomMixin, AsyncAPIResource):
    """
    Inference deployments run containerized ML models with configurable scaling, health probes, and GPU flavors.
    """
