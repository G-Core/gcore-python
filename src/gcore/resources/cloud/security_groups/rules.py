...
from .rules_custom import RulesResourceCustomMixin, AsyncRulesResourceCustomMixin
...
class RulesResource(RulesResourceCustomMixin, SyncAPIResource):
    """
    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          protocol: V2 protocol enum without 'any'. Use null for all protocols instead.
...
class AsyncRulesResource(AsyncRulesResourceCustomMixin, AsyncAPIResource):
    """
    Security group rules define individual traffic permissions specifying protocol, port range, direction, and allowed sources.
    """
