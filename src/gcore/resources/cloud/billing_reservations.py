...
class BillingReservationsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        Args:
          time_from: Start of the reservation period (ISO 8601). The period must not exceed 31 days.
              The API returns monthly pricing for this period.

          time_to: End of the reservation period (ISO 8601). The period must not exceed 31 days.
              The API returns monthly pricing for this period.
