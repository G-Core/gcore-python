...
```python
from gcore.types.cloud import Quota, QuotaGetByRegionResponse, QuotaGetGlobalResponse
```

Methods:

- <code title="get /cloud/v2/client_quotas">client.cloud.quotas.<a href="./src/gcore/resources/cloud/quotas/quotas.py">get_all</a>() -> <a href="./src/gcore/types/cloud/quota.py">Quota</a></code>
...
- <code title="get /cloud/v1/l7policies/{project_id}/{region_id}">client.cloud.load_balancers.l7_policies.<a href="./src/gcore/resources/cloud/load_balancers/l7_policies/l7_policies.py">list</a>(\*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/load_balancers/l7_policy_list_params.py">params</a>) -> <a href="./src/gcore/types/cloud/load_balancer_l7_policy.py">SyncOffsetPage[LoadBalancerL7Policy]</a></code>
...
- <code title="get /cloud/v1/l7policies/{project_id}/{region_id}/{l7policy_id}/rules">client.cloud.load_balancers.l7_policies.rules.<a href="./src/gcore/resources/cloud/load_balancers/l7_policies/rules.py">list</a>(l7policy_id, \*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/load_balancers/l7_policies/rule_list_params.py">params</a>) -> <a href="./src/gcore/types/cloud/load_balancer_l7_rule.py">SyncOffsetPage[LoadBalancerL7Rule]</a></code>
...
- <code title="get /cloud/v1/lbflavors/{project_id}/{region_id}">client.cloud.load_balancers.flavors.<a href="./src/gcore/resources/cloud/load_balancers/flavors.py">list</a>(\*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/load_balancers/flavor_list_params.py">params</a>) -> SyncOffsetPage[Result]</code>
...
- <code title="get /cloud/v1/lblisteners/{project_id}/{region_id}">client.cloud.load_balancers.listeners.<a href="./src/gcore/resources/cloud/load_balancers/listeners.py">list</a>(\*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/load_balancers/listener_list_params.py">params</a>) -> <a href="./src/gcore/types/cloud/load_balancer_listener_detail.py">SyncOffsetPage[LoadBalancerListenerDetail]</a></code>
...
- <code title="get /cloud/v1/lbpools/{project_id}/{region_id}">client.cloud.load_balancers.pools.<a href="./src/gcore/resources/cloud/load_balancers/pools/pools.py">list</a>(\*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/load_balancers/pool_list_params.py">params</a>) -> SyncOffsetPage[Result]</code>
...
- <code title="post /cloud/v1/loadbalancers/{project_id}/{region_id}/pools/{pool_id}/members">client.cloud.load_balancers.pools.members.<a href="./src/gcore/resources/cloud/load_balancers/pools/members.py">create</a>(pool_id, \*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/load_balancers/pools/member_create_params.py">params</a>) -> <a href="./src/gcore/types/cloud/task_id_list.py">TaskIDList</a></code>
- <code title="patch /cloud/v1/loadbalancers/{project_id}/{region_id}/pools/{pool_id}/members/{member_id}">client.cloud.load_balancers.pools.members.<a href="./src/gcore/resources/cloud/load_balancers/pools/members.py">update</a>(member_id, \*, project_id, region_id, pool_id, \*\*<a href="src/gcore/types/cloud/load_balancers/pools/member_update_params.py">params</a>) -> <a href="./src/gcore/types/cloud/task_id_list.py">TaskIDList</a></code>
- <code title="get /cloud/v1/loadbalancers/{project_id}/{region_id}/pools/{pool_id}/members">client.cloud.load_balancers.pools.members.<a href="./src/gcore/resources/cloud/load_balancers/pools/members.py">list</a>(pool_id, \*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/load_balancers/pools/member_list_params.py">params</a>) -> <a href="./src/gcore/types/cloud/member.py">SyncOffsetPage[Member]</a></code>
- <code title="delete /cloud/v1/loadbalancers/{project_id}/{region_id}/pools/{pool_id}/members/{member_id}">client.cloud.load_balancers.pools.members.<a href="./src/gcore/resources/cloud/load_balancers/pools/members.py">delete</a>(member_id, \*, project_id, region_id, pool_id) -> <a href="./src/gcore/types/cloud/task_id_list.py">TaskIDList</a></code>
- <code title="get /cloud/v1/loadbalancers/{project_id}/{region_id}/pools/{pool_id}/members/{member_id}">client.cloud.load_balancers.pools.members.<a href="./src/gcore/resources/cloud/load_balancers/pools/members.py">get</a>(member_id, \*, project_id, region_id, pool_id) -> <a href="./src/gcore/types/cloud/member.py">Member</a></code>
- <code title="put /cloud/v1/loadbalancers/{project_id}/{region_id}/pools/{pool_id}/members">client.cloud.load_balancers.pools.members.<a href="./src/gcore/resources/cloud/load_balancers/pools/members.py">replace</a>(pool_id, \*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/load_balancers/pools/member_replace_params.py">params</a>) -> <a href="./src/gcore/types/cloud/task_id_list.py">TaskIDList</a></code>
...
- <code title="post /cloud/v2/security_groups/{project_id}/{region_id}/{group_id}/rules">client.cloud.security_groups.rules.<a href="./src/gcore/resources/cloud/security_groups/rules.py">create</a>(group_id, \*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/security_groups/rule_create_params.py">params</a>) -> <a href="./src/gcore/types/cloud/task_id_list.py">TaskIDList</a></code>
- <code title="delete /cloud/v2/security_groups/{project_id}/{region_id}/{group_id}/rules/{rule_id}">client.cloud.security_groups.rules.<a href="./src/gcore/resources/cloud/security_groups/rules.py">delete</a>(rule_id, \*, project_id, region_id, group_id) -> <a href="./src/gcore/types/cloud/task_id_list.py">TaskIDList</a></code>
...
- <code title="post /cloud/v2/baremetal/{project_id}/{region_id}/{server_id}/action">client.cloud.baremetal.servers.<a href="./src/gcore/resources/cloud/baremetal/servers.py">action</a>(server_id, \*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/baremetal/server_action_params.py">params</a>) -> <a href="./src/gcore/types/cloud/task_id_list.py">TaskIDList</a></code>
...
- <code title="post /cloud/v1/registries/{project_id}/{region_id}/{registry_id}/users/batch">client.cloud.registries.users.<a href="./src/gcore/resources/cloud/registries/users.py">create_multiple</a>(registry_id, \*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/registries/user_create_multiple_params.py">params</a>) -> <a href="./src/gcore/types/cloud/registries/user_create_multiple_response.py">UserCreateMultipleResponse</a></code>
...
- <code title="post /cloud/v3/gpu/baremetal/{project_id}/{region_id}/clusters/{cluster_id}/apply_settings">client.cloud.gpu_baremetal.clusters.<a href="./src/gcore/resources/cloud/gpu_baremetal/clusters/clusters.py">apply_settings</a>(cluster_id, \*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/gpu_baremetal/cluster_apply_settings_params.py">params</a>) -> <a href="./src/gcore/types/cloud/task_id_list.py">TaskIDList</a></code>
...
- <code title="post /cloud/v3/gpu/baremetal/{project_id}/{region_id}/clusters/{cluster_id}/rebuild">client.cloud.gpu_baremetal.clusters.<a href="./src/gcore/resources/cloud/gpu_baremetal/clusters/clusters.py">rebuild</a>(cluster_id, \*, project_id, region_id) -> <a href="./src/gcore/types/cloud/task_id_list.py">TaskIDList</a></code>
...
- <code title="patch /cloud/v3/gpu/baremetal/{project_id}/{region_id}/clusters/{cluster_id}/servers_settings">client.cloud.gpu_baremetal.clusters.<a href="./src/gcore/resources/cloud/gpu_baremetal/clusters/clusters.py">update_servers_settings</a>(cluster_id, \*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/gpu_baremetal/cluster_update_servers_settings_params.py">params</a>) -> <a href="./src/gcore/types/cloud/gpu_baremetal/gpu_baremetal_cluster.py">GPUBaremetalCluster</a></code>

#### Interfaces

Methods:

- <code title="get /cloud/v1/ai/clusters/{project_id}/{region_id}/{cluster_id}/interfaces">client.cloud.gpu_baremetal.clusters.interfaces.<a href="./src/gcore/resources/cloud/gpu_baremetal/clusters/interfaces.py">list</a>(cluster_id, \*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/gpu_baremetal/clusters/interface_list_params.py">params</a>) -> <a href="./src/gcore/types/cloud/network_interface.py">SyncOffsetPage[NetworkInterface]</a></code>
...
- <code title="post /cloud/v3/gpu/baremetal/{project_id}/{region_id}/clusters/{cluster_id}/servers/{server_id}/apply_settings">client.cloud.gpu_baremetal.clusters.servers.<a href="./src/gcore/resources/cloud/gpu_baremetal/clusters/servers.py">apply_settings</a>(server_id, \*, project_id, region_id, cluster_id, \*\*<a href="src/gcore/types/cloud/gpu_baremetal/clusters/server_apply_settings_params.py">params</a>) -> <a href="./src/gcore/types/cloud/task_id_list.py">TaskIDList</a></code>
- <code title="get /cloud/v1/ai/clusters/{project_id}/{region_id}/{instance_id}/get_console">client.cloud.gpu_baremetal.clusters.servers.<a href="./src/gcore/resources/cloud/gpu_baremetal/clusters/servers.py">get_console</a>(instance_id, \*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/gpu_baremetal/clusters/server_get_console_params.py">params</a>) -> <a href="./src/gcore/types/cloud/console.py">Console</a></code>
...
- <code title="get /cloud/v3/gpu/virtual/{project_id}/{region_id}/clusters/{cluster_id}/servers">client.cloud.gpu_virtual.clusters.servers.<a href="./src/gcore/resources/cloud/gpu_virtual/clusters/servers.py">list</a>(cluster_id, \*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/gpu_virtual/clusters/server_list_params.py">params</a>) -> <a href="./src/gcore/types/cloud/gpu_virtual/clusters/gpu_virtual_cluster_server.py">SyncOffsetPage[GPUVirtualClusterServer]</a></code>
...
- <code title="get /cloud/v1/instances/{project_id}/{region_id}/{instance_id}/interfaces">client.cloud.instances.interfaces.<a href="./src/gcore/resources/cloud/instances/interfaces.py">list</a>(instance_id, \*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/instances/interface_list_params.py">params</a>) -> <a href="./src/gcore/types/cloud/network_interface.py">SyncOffsetPage[NetworkInterface]</a></code>
...
- <code title="post /cloud/v1/lifecycle_policy/{project_id}/{region_id}">client.cloud.snapshot_schedules.<a href="./src/gcore/resources/cloud/snapshot_schedules.py">create</a>(\*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/snapshot_schedule_create_params.py">params</a>) -> <a href="./src/gcore/types/cloud/lifecycle_policy.py">LifecyclePolicy</a></code>
- <code title="patch /cloud/v1/lifecycle_policy/{project_id}/{region_id}/{policy_id}">client.cloud.snapshot_schedules.<a href="./src/gcore/resources/cloud/snapshot_schedules.py">update</a>(policy_id, \*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/snapshot_schedule_update_params.py">params</a>) -> <a href="./src/gcore/types/cloud/lifecycle_policy.py">LifecyclePolicy</a></code>
- <code title="get /cloud/v1/lifecycle_policy/{project_id}/{region_id}">client.cloud.snapshot_schedules.<a href="./src/gcore/resources/cloud/snapshot_schedules.py">list</a>(\*, project_id, region_id) -> <a href="./src/gcore/types/cloud/snapshot_schedule_list_response.py">SnapshotScheduleListResponse</a></code>
- <code title="delete /cloud/v1/lifecycle_policy/{project_id}/{region_id}/{policy_id}">client.cloud.snapshot_schedules.<a href="./src/gcore/resources/cloud/snapshot_schedules.py">delete</a>(policy_id, \*, project_id, region_id) -> None</code>
- <code title="post /cloud/v1/lifecycle_policy/{project_id}/{region_id}/{policy_id}/add_schedules">client.cloud.snapshot_schedules.<a href="./src/gcore/resources/cloud/snapshot_schedules.py">add_schedules</a>(policy_id, \*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/snapshot_schedule_add_schedules_params.py">params</a>) -> <a href="./src/gcore/types/cloud/lifecycle_policy.py">LifecyclePolicy</a></code>
- <code title="put /cloud/v1/lifecycle_policy/{project_id}/{region_id}/{policy_id}/add_volumes_to_policy">client.cloud.snapshot_schedules.<a href="./src/gcore/resources/cloud/snapshot_schedules.py">add_volumes</a>(policy_id, \*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/snapshot_schedule_add_volumes_params.py">params</a>) -> <a href="./src/gcore/types/cloud/lifecycle_policy.py">LifecyclePolicy</a></code>
- <code title="post /cloud/v1/lifecycle_policy/{project_id}/{region_id}/estimate_max_policy_usage">client.cloud.snapshot_schedules.<a href="./src/gcore/resources/cloud/snapshot_schedules.py">estimate_max_usage</a>(\*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/snapshot_schedule_estimate_max_usage_params.py">params</a>) -> <a href="./src/gcore/types/cloud/snapshot_schedule_estimate_max_usage_response.py">SnapshotScheduleEstimateMaxUsageResponse</a></code>
- <code title="get /cloud/v1/lifecycle_policy/{project_id}/{region_id}/{policy_id}">client.cloud.snapshot_schedules.<a href="./src/gcore/resources/cloud/snapshot_schedules.py">get</a>(policy_id, \*, project_id, region_id) -> <a href="./src/gcore/types/cloud/lifecycle_policy.py">LifecyclePolicy</a></code>
- <code title="post /cloud/v1/lifecycle_policy/{project_id}/{region_id}/{policy_id}/remove_schedules">client.cloud.snapshot_schedules.<a href="./src/gcore/resources/cloud/snapshot_schedules.py">remove_schedules</a>(policy_id, \*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/snapshot_schedule_remove_schedules_params.py">params</a>) -> <a href="./src/gcore/types/cloud/lifecycle_policy.py">LifecyclePolicy</a></code>
- <code title="put /cloud/v1/lifecycle_policy/{project_id}/{region_id}/{policy_id}/remove_volumes_from_policy">client.cloud.snapshot_schedules.<a href="./src/gcore/resources/cloud/snapshot_schedules.py">remove_volumes</a>(policy_id, \*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/snapshot_schedule_remove_volumes_params.py">params</a>) -> <a href="./src/gcore/types/cloud/lifecycle_policy.py">LifecyclePolicy</a></code>
...
- <code title="get /cloud/v1/snapshots/{project_id}/{region_id}">client.cloud.volume_snapshots.<a href="./src/gcore/resources/cloud/volume_snapshots.py">list</a>(\*, project_id, region_id, \*\*<a href="src/gcore/types/cloud/volume_snapshot_list_params.py">params</a>) -> <a href="./src/gcore/types/cloud/snapshot.py">SyncOffsetPage[Snapshot]</a></code>
