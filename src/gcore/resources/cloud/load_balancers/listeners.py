...
from .listeners_custom import ListenersResourceCustomMixin, AsyncListenersResourceCustomMixin
...
class ListenersResource(ListenersResourceCustomMixin, SyncAPIResource):
    """
...
class AsyncListenersResource(AsyncListenersResourceCustomMixin, AsyncAPIResource):
    """
    Load balancer listeners handle incoming traffic on specified protocols and ports, forwarding requests to backend pools.
    """
