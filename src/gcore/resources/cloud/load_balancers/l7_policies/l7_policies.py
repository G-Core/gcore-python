...
class L7PoliciesResource(SyncAPIResource):
    ...
    def create_and_poll(
        ...
        *,
        ...
        """Create L7 policy and poll for completion."""
        response: TaskIDList = self.create(  # type: ignore[call-overload]
    ...
    def replace_and_poll(
        ...
        *,
        ...
        """Replace L7 policy and poll for completion."""
        response: TaskIDList = self.replace(  # type: ignore[call-overload]
            l7policy_id=l7policy_id,
            project_id=project_id,
            region_id=region_id,
            action=action,
...
class AsyncL7PoliciesResource(AsyncAPIResource):
    ...
    async def create_and_poll(
        ...
        *,
        ...
        """Create L7 policy and poll for completion."""
        response: TaskIDList = await self.create(  # type: ignore[call-overload]
            project_id=project_id,
            region_id=region_id,
            action=action,
            listener_id=listener_id,
    ...
    async def replace_and_poll(
        ...
        *,
        ...
        """Replace L7 policy and poll for completion."""
        response: TaskIDList = await self.replace(  # type: ignore[call-overload]
            l7policy_id=l7policy_id,
            project_id=project_id,
            region_id=region_id,
            action=action,
