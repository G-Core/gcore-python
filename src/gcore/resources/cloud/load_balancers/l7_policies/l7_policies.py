...
from .l7_policies_custom import L7PoliciesResourceCustomMixin, AsyncL7PoliciesResourceCustomMixin
...
class L7PoliciesResource(L7PoliciesResourceCustomMixin, SyncAPIResource):
    @cached_property
...
class AsyncL7PoliciesResource(AsyncL7PoliciesResourceCustomMixin, AsyncAPIResource):
    @cached_property
