...
from .load_balancers_custom import LoadBalancersResourceCustomMixin, AsyncLoadBalancersResourceCustomMixin
...
class LoadBalancersResource(LoadBalancersResourceCustomMixin, SyncAPIResource):
    """
...
class AsyncLoadBalancersResource(AsyncLoadBalancersResourceCustomMixin, AsyncAPIResource):
    """
    Load balancers distribute incoming traffic across multiple instances with support for listeners, pools, and health monitoring.
    """
