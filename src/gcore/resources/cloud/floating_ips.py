...
from .floating_ips_custom import FloatingIPsResourceCustomMixin, AsyncFloatingIPsResourceCustomMixin
...
class FloatingIPsResource(FloatingIPsResourceCustomMixin, SyncAPIResource):
...
class AsyncFloatingIPsResource(AsyncFloatingIPsResourceCustomMixin, AsyncAPIResource):
    """A floating IP is a static IP address that points to one of your Instances.
