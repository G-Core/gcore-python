...
class VolumeSnapshotsResource(VolumeSnapshotsResourceCustomMixin, SyncAPIResource):
    @cached_property
...
class AsyncVolumeSnapshotsResource(AsyncVolumeSnapshotsResourceCustomMixin, AsyncAPIResource):
    @cached_property
