        ...
        *,
        ...
        Filter the tasks by creation date greater than or
          ...
          task_type: Filter the tasks by their type one of ['activate_ddos_profile',
              ...
              'extend_volume', 'failover_loadbalancer', 'hard_reboot_gpu_baremetal_cluster',
              ...
              'resize_vm', 'resume_vm', 'revert_volume', 'soft_reboot_gpu_baremetal_cluster',
              ...
              'start_gpu_virtual_cluster', 'start_gpu_virtual_server', 'start_vm',
