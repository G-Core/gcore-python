...
class TasksResource(SyncAPIResource):
        ...
        *,
        ...
        Filter the tasks by creation date greater than or
          ...
          task_type: Filter the tasks by their type one of ['activate_ddos_profile',
              ...
              'create_ai_cluster_gpu', 'create_basic_vm', 'create_bm',
              'create_caas_container', 'create_dbaas_postgres_cluster', 'create_ddos_profile',
              'create_faas_function', 'create_faas_namespace', 'create_fip',
              'create_gpu_virtual_cluster', 'create_image', 'create_inference_application',
              'create_inference_instance', 'create_k8s_cluster_pool_v2',
              ...
              'create_sfs', 'create_slurm_cluster', 'create_slurm_node_set',
              'create_snapshot', 'create_subnet', 'create_vm', 'create_volume',
              'deactivate_ddos_profile', 'delete_ai_cluster_gpu', 'delete_basic_vm',
              'delete_caas_container', 'delete_dbaas_postgres_cluster', 'delete_ddos_profile',
              ...
              'delete_lbpool', 'delete_loadbalancer', 'delete_network', 'delete_project',
              'delete_reserved_fixed_ip', 'delete_router', 'delete_secret',
              'delete_security_group_rule', 'delete_servergroup', 'delete_sfs',
              'delete_slurm_cluster', 'delete_slurm_node_set', 'delete_snapshot',
              ...
              'failover_loadbalancer', 'hard_reboot_bm', 'hard_reboot_gpu_baremetal_cluster',
    ...
    def acknowledge_one(
        ...
        *,
        ...
        return self._post(
            path_template("/cloud/v1/tasks/{task_id}/acknowledge", task_id=task_id),
            options=make_request_options(
    ...
    def get(
        ...
        *,
        ...
        if not task_id:
            raise ValueError(f"Expected a non-empty value for `task_id` but received {task_id!r}")
        return self._get(
            path_template("/cloud/v1/tasks/{task_id}", task_id=task_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=Task,
