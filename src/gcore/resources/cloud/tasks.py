        ...
        *,
        ...
        Filter the tasks by creation date greater than or
          ...
          task_type: Filter the tasks by their type one of ['activate_ddos_profile',
              ...
              'resize_vm', 'resume_vm', 'revert_volume', 'soft_reboot_bm',
              'soft_reboot_gpu_baremetal_cluster', 'soft_reboot_gpu_baremetal_server',
              'soft_reboot_gpu_virtual_cluster', 'soft_reboot_gpu_virtual_server',
              'soft_reboot_vm', 'start_bm', 'start_gpu_baremetal_cluster',
              'start_gpu_baremetal_server', 'start_gpu_virtual_cluster',
              'start_gpu_virtual_server', 'start_vm', 'stop_bm', 'stop_gpu_baremetal_cluster',
              'stop_gpu_baremetal_server', 'stop_gpu_virtual_cluster',
              'stop_gpu_virtual_server', 'stop_vm', 'suspend_vm', 'sync_private_flavors',
              'update_ddos_profile', 'update_floating_ip', 'update_inference_application',
              'update_inference_instance', 'update_k8s_cluster_v2', 'update_l7policy',
              'update_lbmetadata', 'update_loadbalancer', 'update_port_allowed_address_pairs',
              'update_router', 'update_security_group', 'update_sfs',
