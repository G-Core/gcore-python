...
from .reserved_fixed_ips_custom import ReservedFixedIPsResourceCustomMixin, AsyncReservedFixedIPsResourceCustomMixin
...
class ReservedFixedIPsResource(ReservedFixedIPsResourceCustomMixin, SyncAPIResource):
    """
...
class AsyncReservedFixedIPsResource(AsyncReservedFixedIPsResourceCustomMixin, AsyncAPIResource):
    """
    Reserved fixed IPs are static IP addresses that persist independently of instances and can be used as virtual IPs (VIPs) for high availability.
    """
