...
from .pools_custom import PoolsResourceCustomMixin, AsyncPoolsResourceCustomMixin
...
class PoolsResource(PoolsResourceCustomMixin, SyncAPIResource):
    @cached_property
...
class AsyncPoolsResource(AsyncPoolsResourceCustomMixin, AsyncAPIResource):
    @cached_property
