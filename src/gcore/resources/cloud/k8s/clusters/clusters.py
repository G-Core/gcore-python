...
class ClustersResource(ClustersResourceCustomMixin, SyncAPIResource):
    """
...
class AsyncClustersResource(AsyncClustersResourceCustomMixin, AsyncAPIResource):
    """
    Managed Kubernetes clusters with configurable worker node pools, networking, and cluster add-ons.
    """
...
class AsyncClustersResourceWithRawResponse:
    def __init__(self, clusters: AsyncClustersResource) -> None:
        ...
        self.upgrade_and_poll = async_to_raw_response_wrapper(
            clusters.upgrade_and_poll,
        )
...
class ClustersResourceWithStreamingResponse:
    def __init__(self, clusters: ClustersResource) -> None:
        ...
        self.upgrade_and_poll = to_streamed_response_wrapper(
            clusters.upgrade_and_poll,
        )
...
class AsyncClustersResourceWithStreamingResponse:
    def __init__(self, clusters: AsyncClustersResource) -> None:
        ...
        self.upgrade_and_poll = async_to_streamed_response_wrapper(
            clusters.upgrade_and_poll,
        )
