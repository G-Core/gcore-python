...
from .....types.cloud.gpu_baremetal.clusters import image_list_params, image_upload_params

__all__ = ["ImagesResource", "AsyncImagesResource"]


class ImagesResource(ImagesResourceCustomMixin, SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            path_template(
                "/cloud/v3/gpu/baremetal/{project_id}/{region_id}/images", project_id=project_id, region_id=region_id
            ),
...
class AsyncImagesResource(AsyncImagesResourceCustomMixin, AsyncAPIResource):
    """GPU bare metal images are custom boot images for bare metal GPU servers."""
