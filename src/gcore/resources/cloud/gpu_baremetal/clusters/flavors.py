...
from .....types.cloud.gpu_baremetal.clusters.gpu_baremetal_flavor import GPUBaremetalFlavor
...
class FlavorsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
    ...
    ) -> SyncOffsetPage[GPUBaremetalFlavor]:
        """
        ...
        return self._get_api_list(
            path_template(
                "/cloud/v3/gpu/baremetal/{project_id}/{region_id}/flavors", project_id=project_id, region_id=region_id
            ),
            page=SyncOffsetPage[GPUBaremetalFlavor],
            ...
            model=cast(Any, GPUBaremetalFlavor),  # Union types cannot be passed in as arguments in the type system
        )
...
class AsyncFlavorsResource(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = not_given,
    ) -> AsyncPaginator[GPUBaremetalFlavor, AsyncOffsetPage[GPUBaremetalFlavor]]:
        """
        List bare metal GPU flavors
        ...
        return self._get_api_list(
            ...
            page=AsyncOffsetPage[GPUBaremetalFlavor],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
