...
class TestZones:
    ...
    def test_raw_response_update(self, client: Gcore) -> None:
        response = client.dns.zones.with_raw_response.update(
            path_name="name",
            body_name="example.com",
        )
    ...
    def test_streaming_response_update(self, client: Gcore) -> None:
        with client.dns.zones.with_streaming_response.update(
            path_name="name",
            body_name="example.com",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_update(self, client: Gcore) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `path_name` but received ''"):
            client.dns.zones.with_raw_response.update(
                path_name="",
                body_name="example.com",
            )
...
class TestAsyncZones:
    ...
    async def test_method_update(self, async_client: AsyncGcore) -> None:
        zone = await async_client.dns.zones.update(
            path_name="name",
            body_name="example.com",
        )
        assert_matches_type(object, zone, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncGcore) -> None:
        response = await async_client.dns.zones.with_raw_response.update(
            path_name="name",
            body_name="example.com",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncGcore) -> None:
        async with async_client.dns.zones.with_streaming_response.update(
            path_name="name",
            body_name="example.com",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_update(self, async_client: AsyncGcore) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `path_name` but received ''"):
            await async_client.dns.zones.with_raw_response.update(
                path_name="",
                body_name="example.com",
            )
