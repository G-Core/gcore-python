...
from gcore.types.security import EventLog, ClientView
...
class TestEvents:
    ...
    def test_method_get(self, client: Gcore) -> None:
        event = client.security.events.get(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(EventLog, event, path=["response"])

    @parametrize
    def test_raw_response_get(self, client: Gcore) -> None:
        response = client.security.events.with_raw_response.get(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_get(self, client: Gcore) -> None:
        with client.security.events.with_streaming_response.get(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_get(self, client: Gcore) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `event_log_id` but received ''"):
            client.security.events.with_raw_response.get(
                "",
            )
...
class TestAsyncEvents:
    ...
    async def test_method_get(self, async_client: AsyncGcore) -> None:
        event = await async_client.security.events.get(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(EventLog, event, path=["response"])
    ...
    async def test_raw_response_get(self, async_client: AsyncGcore) -> None:
        response = await async_client.security.events.with_raw_response.get(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_get(self, async_client: AsyncGcore) -> None:
        async with async_client.security.events.with_streaming_response.get(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get(self, async_client: AsyncGcore) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `event_log_id` but received ''"):
            await async_client.security.events.with_raw_response.get(
                "",
            )
