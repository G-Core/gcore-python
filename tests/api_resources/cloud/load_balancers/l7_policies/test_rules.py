...
from gcore.types.cloud import L7Rule, L7RuleList, TaskIDList
...
class TestRules:
    ...
    def test_method_list(self, client: Gcore) -> None:
        ...
        assert_matches_type(L7RuleList, rule, path=["response"])
    ...
    def test_method_get(self, client: Gcore) -> None:
        ...
        assert_matches_type(L7Rule, rule, path=["response"])
