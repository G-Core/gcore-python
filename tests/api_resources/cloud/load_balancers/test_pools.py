...
from gcore.types.cloud import TaskIDList, LoadBalancerPool
from gcore.types.cloud.load_balancer_pool_list import Result
...
class TestPools:
    ...
    def test_method_list(self, client: Gcore) -> None:
        ...
        assert_matches_type(SyncOffsetPage[Result], pool, path=["response"])
...
class TestAsyncPools:
    ...
    async def test_method_list(self, async_client: AsyncGcore) -> None:
        ...
        assert_matches_type(AsyncOffsetPage[Result], pool, path=["response"])
