...
from gcore.types.cloud.load_balancer_flavor_list import Result
...
class TestFlavors:
    ...
    def test_method_list(self, client: Gcore) -> None:
        ...
        assert_matches_type(SyncOffsetPage[Result], flavor, path=["response"])
...
class TestAsyncFlavors:
    ...
    async def test_method_list(self, async_client: AsyncGcore) -> None:
        ...
        assert_matches_type(AsyncOffsetPage[Result], flavor, path=["response"])
