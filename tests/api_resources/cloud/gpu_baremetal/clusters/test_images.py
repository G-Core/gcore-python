...
from gcore.types.cloud import GPUImage, TaskIDList
...
class TestImages:
    ...
    def test_method_list(self, client: Gcore) -> None:
        ...
        assert_matches_type(SyncOffsetPage[GPUImage], image, path=["response"])
...
class TestAsyncImages:
    ...
    async def test_method_list(self, async_client: AsyncGcore) -> None:
        ...
        assert_matches_type(AsyncOffsetPage[GPUImage], image, path=["response"])
