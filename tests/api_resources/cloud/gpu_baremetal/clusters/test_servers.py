...
class TestServers:
    ...
    def test_method_apply_settings(self, client: Gcore) -> None:
        server = client.cloud.gpu_baremetal.clusters.servers.apply_settings(
    ...
    def test_raw_response_apply_settings(self, client: Gcore) -> None:
        response = client.cloud.gpu_baremetal.clusters.servers.with_raw_response.apply_settings(
            server_id="f1c1eeb6-1834-48c9-a7b0-daafce64872b",
            project_id=1,
            region_id=7,
            cluster_id="1aaaab48-10d0-46d9-80cc-85209284ceb4",
    ...
    def test_streaming_response_apply_settings(self, client: Gcore) -> None:
        with client.cloud.gpu_baremetal.clusters.servers.with_streaming_response.apply_settings(
            server_id="f1c1eeb6-1834-48c9-a7b0-daafce64872b",
            project_id=1,
            region_id=7,
            cluster_id="1aaaab48-10d0-46d9-80cc-85209284ceb4",
    ...
    def test_path_params_apply_settings(self, client: Gcore) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `cluster_id` but received ''"):
            client.cloud.gpu_baremetal.clusters.servers.with_raw_response.apply_settings(
                server_id="f1c1eeb6-1834-48c9-a7b0-daafce64872b",
                project_id=1,
                region_id=7,
                cluster_id="",
...
class TestAsyncServers:
    ...
    async def test_method_apply_settings(self, async_client: AsyncGcore) -> None:
        server = await async_client.cloud.gpu_baremetal.clusters.servers.apply_settings(
            server_id="f1c1eeb6-1834-48c9-a7b0-daafce64872b",
            project_id=1,
            region_id=7,
            cluster_id="1aaaab48-10d0-46d9-80cc-85209284ceb4",
    ...
    async def test_raw_response_apply_settings(self, async_client: AsyncGcore) -> None:
        response = await async_client.cloud.gpu_baremetal.clusters.servers.with_raw_response.apply_settings(
            server_id="f1c1eeb6-1834-48c9-a7b0-daafce64872b",
            project_id=1,
            region_id=7,
            cluster_id="1aaaab48-10d0-46d9-80cc-85209284ceb4",
    ...
    async def test_streaming_response_apply_settings(self, async_client: AsyncGcore) -> None:
        async with async_client.cloud.gpu_baremetal.clusters.servers.with_streaming_response.apply_settings(
            server_id="f1c1eeb6-1834-48c9-a7b0-daafce64872b",
            project_id=1,
            region_id=7,
            cluster_id="1aaaab48-10d0-46d9-80cc-85209284ceb4",
    ...
    async def test_path_params_apply_settings(self, async_client: AsyncGcore) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `cluster_id` but received ''"):
            await async_client.cloud.gpu_baremetal.clusters.servers.with_raw_response.apply_settings(
                server_id="f1c1eeb6-1834-48c9-a7b0-daafce64872b",
                project_id=1,
                region_id=7,
                cluster_id="",
