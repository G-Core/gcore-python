...
class TestRegions:
    ...
    def test_method_retrieve(self, client: Gcore) -> None:
        region = client.cloud.regions.retrieve(
            region_id=11,
        )
        assert_matches_type(Region, region, path=["response"])

    @parametrize
    def test_method_retrieve_with_all_params(self, client: Gcore) -> None:
        region = client.cloud.regions.retrieve(
            region_id=11,
    ...
    def test_raw_response_retrieve(self, client: Gcore) -> None:
        response = client.cloud.regions.with_raw_response.retrieve(
            region_id=11,
        )
    ...
    def test_streaming_response_retrieve(self, client: Gcore) -> None:
        with client.cloud.regions.with_streaming_response.retrieve(
            region_id=11,
        ) as response:
...
class TestAsyncRegions:
    ...
    async def test_method_retrieve(self, async_client: AsyncGcore) -> None:
        region = await async_client.cloud.regions.retrieve(
            region_id=11,
        )
        assert_matches_type(Region, region, path=["response"])

    @parametrize
    async def test_method_retrieve_with_all_params(self, async_client: AsyncGcore) -> None:
        region = await async_client.cloud.regions.retrieve(
            region_id=11,
            show_volume_types=False,
        )
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncGcore) -> None:
        response = await async_client.cloud.regions.with_raw_response.retrieve(
            region_id=11,
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncGcore) -> None:
        async with async_client.cloud.regions.with_streaming_response.retrieve(
            region_id=11,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
