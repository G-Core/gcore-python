...
class TestFlavors:
    ...
    def test_method_list(self, client: Gcore) -> None:
        flavor = client.cloud.baremetal.flavors.list(
            project_id=0,
            region_id=0,
        )
    ...
    def test_raw_response_list(self, client: Gcore) -> None:
        response = client.cloud.baremetal.flavors.with_raw_response.list(
            project_id=0,
            region_id=0,
        )
    ...
    def test_streaming_response_list(self, client: Gcore) -> None:
        with client.cloud.baremetal.flavors.with_streaming_response.list(
            project_id=0,
            region_id=0,
        ) as response:
    ...
    def test_method_list_suitable(self, client: Gcore) -> None:
        flavor = client.cloud.baremetal.flavors.list_suitable(
            project_id=0,
            region_id=0,
        )
    ...
    def test_raw_response_list_suitable(self, client: Gcore) -> None:
        response = client.cloud.baremetal.flavors.with_raw_response.list_suitable(
            project_id=0,
            region_id=0,
        )
    ...
    def test_streaming_response_list_suitable(self, client: Gcore) -> None:
        with client.cloud.baremetal.flavors.with_streaming_response.list_suitable(
            project_id=0,
            region_id=0,
        ) as response:
            assert not response.is_closed
...
class TestAsyncFlavors:
    ...
    async def test_method_list(self, async_client: AsyncGcore) -> None:
        flavor = await async_client.cloud.baremetal.flavors.list(
            project_id=0,
            region_id=0,
        )
        assert_matches_type(FlavorListResponse, flavor, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncGcore) -> None:
        response = await async_client.cloud.baremetal.flavors.with_raw_response.list(
            project_id=0,
            region_id=0,
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncGcore) -> None:
        async with async_client.cloud.baremetal.flavors.with_streaming_response.list(
            project_id=0,
            region_id=0,
        ) as response:
            assert not response.is_closed
    ...
    async def test_method_list_suitable(self, async_client: AsyncGcore) -> None:
        flavor = await async_client.cloud.baremetal.flavors.list_suitable(
            project_id=0,
            region_id=0,
        )
        assert_matches_type(FlavorListSuitableResponse, flavor, path=["response"])
    ...
    async def test_raw_response_list_suitable(self, async_client: AsyncGcore) -> None:
        response = await async_client.cloud.baremetal.flavors.with_raw_response.list_suitable(
            project_id=0,
            region_id=0,
        )
    ...
    async def test_streaming_response_list_suitable(self, async_client: AsyncGcore) -> None:
        async with async_client.cloud.baremetal.flavors.with_streaming_response.list_suitable(
            project_id=0,
            region_id=0,
        ) as response:
            assert not response.is_closed
