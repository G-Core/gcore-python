...
from gcore._utils import asyncify
...
def _get_open_connections(client: Gcore | AsyncGcore) -> int:
...
class TestGcore:
    ...
    def test_client_timeout_option(self) -> None:
        client = Gcore(base_url=base_url, api_key=api_key, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(GcoreError):
            with update_env(**{"GCORE_API_KEY": Omit()}):
                client2 = Gcore(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_hardcoded_query_params_in_url(self, client: Gcore) -> None:
    ...
    def test_multipart_repeating_array(self, client: Gcore) -> None:
        request = client._build_request(
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: Gcore) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload_with_body_is_deprecated(self, respx_mock: MockRouter, client: Gcore) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    def test_base_url_setter(self) -> None:
        client = Gcore(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    @pytest.mark.parametrize(
        "client",
        [
            Gcore(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            Gcore(
    ...
    def test_base_url_trailing_slash(self, client: Gcore) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Gcore) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Gcore) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Gcore(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Gcore(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    @mock.patch("gcore._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_omit_retry_count_header(self, client: Gcore, failures_before_success: int, respx_mock: MockRouter) -> None:
        client = client.with_options(max_retries=4)
    ...
    def test_overwrite_retry_count_header(
        self, client: Gcore, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncGcore:
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncGcore) -> None:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncGcore) -> None:
        request = async_client._build_request(
            FinalRequestOptions.construct(
                method="post",
                url="/foo",
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncGcore) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncGcore(base_url=base_url, api_key=api_key, _strict_response_validation=True)
